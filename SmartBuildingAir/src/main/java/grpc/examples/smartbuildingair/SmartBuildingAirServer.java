...
import grpc.examples.smartbuildingair.GreeterGrpc.GreeterImplBase;
import io.grpc.Server;
import io.grpc.ServerBuilder;
import io.grpc.stub.StreamObserver;

public class SmartBuildingAirServer extends GreeterImplBase {

	private static final Logger logger = Logger.getLogger(SmartBuildingAirServer.class.getName());

	public static void main(String[] args) {
		
		SmartBuildingAirServer greeterserver = new SmartBuildingAirServer();
